...
export const PRESET_GROUPS = [
  {
    ...
    presets: [
      { id: 'duty-load', label: 'Duty load by clinician', icon: '⭐',
        description: 'Share of each clinician\u2019s sessions spent as duty doctor. Colour-coded against the fair share.',
        config: { grain: 'sessions', num: { kinds: ['duty'] }, denomMode: 'group', groupBy: 'clinician', range: 'last8next8', chart: 'bars', colourMode: 'conditional', colourInvert: true } },
      { id: 'support-load', label: 'Support load by clinician', icon: '🤝',
        description: 'Share of sessions spent as the support doctor, per clinician.',
        config: { grain: 'sessions', num: { kinds: ['support'] }, denomMode: 'group', groupBy: 'clinician', range: 'last8next8', chart: 'bars', colourMode: 'conditional', colourInvert: true } },
      { id: 'sessions-worked', label: 'Sessions worked by clinician', icon: '📋',
        description: 'Total AM and PM sessions each clinician worked over the period.',
        config: { grain: 'sessions', num: { kinds: ['worked'] }, denomMode: 'none', groupBy: 'clinician', range: 'last8next8', chart: 'bars', colourMode: 'multi' } },
      { id: 'oncall-load', label: 'On-call load by clinician', icon: '⚖️',
        description: 'Total duty plus support sessions each clinician covered.',
        config: { grain: 'sessions', num: { kinds: ['duty','support'] }, denomMode: 'none', groupBy: 'clinician', range: 'last8next8', chart: 'bars', colourMode: 'multi' } },
    ],
  },
  {
    group: 'Capacity & fill',
    ...
    presets: [
      { id: 'fill-by-clinician', label: 'Fill rate by clinician', icon: '🎯',
      ...
      { id: 'offered-by-clinician', label: 'Slots offered by clinician', icon: '📦',
      ...
      { id: 'fill-by-week', label: 'Fill rate by week', icon: '📈',
      ...
      { id: 'offered-by-location', label: 'Slots offered by site', icon: '🏥',
  ...
  },
  {
    ...
    presets: [
      { id: 'booked-by-dow', label: 'Bookings by day of week', icon: '📅',
      ...
      { id: 'urgent-by-week', label: 'Urgent slots by week', icon: '🚨',
      ...
      { id: 'routine-by-week', label: 'Routine slots by week', icon: '🗓️',
  ...
  },
  {
    ...
    presets: [
      { id: 'status-mix-by-week', label: 'Status mix by week', icon: '🧩',
      ...
      { id: 'urgent-routine-by-clinician', label: 'Urgent vs routine by clinician', icon: '📊',
      ...
      { id: 'urgent-share-by-clinician', label: 'Urgent share by clinician', icon: '🔺',
