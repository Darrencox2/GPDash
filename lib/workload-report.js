...
export const PRESET_GROUPS = [
  {
    ...
    presets: [
      ...
      { id: 'duty-by-week', label: 'Duty sessions by week',
        description: 'How many duty sessions were covered each week over time.',
        config: { grain: 'sessions', num: { kinds: ['duty'] }, denomMode: 'none', groupBy: 'week', range: 'last8next8', chart: 'trend', colourMode: 'single' } },
    ],
  },
  {
    group: 'Capacity & fill',
