...
export function runReport(facts, config) {
  ...
  return { groups: groupArr, series, hasSplit: !!splitKeyer, denomMode, totalNum, totalDenom: overallDenom, totalAll, totalValue, isRatio };
}
...
export const PRESET_GROUPS = [
  {
    ...
    presets: [
      { id: 'duty-load', label: 'Duty load by clinician',
        config: { grain: 'sessions', num: { kinds: ['duty'] }, denomMode: 'group', groupBy: 'clinician', range: 'last8next8', chart: 'bars' } },
      { id: 'support-load', label: 'Support load by clinician',
        config: { grain: 'sessions', num: { kinds: ['support'] }, denomMode: 'group', groupBy: 'clinician', range: 'last8next8', chart: 'bars' } },
      { id: 'sessions-worked', label: 'Sessions worked by clinician',
        config: { grain: 'sessions', num: { kinds: ['worked'] }, denomMode: 'none', groupBy: 'clinician', range: 'last8next8', chart: 'bars' } },
      { id: 'duty-by-week', label: 'Duty sessions by week',
        config: { grain: 'sessions', num: { kinds: ['duty'] }, denomMode: 'none', groupBy: 'week', range: 'last8next8', chart: 'trend' } },
    ],
  },
  {
    group: 'Slots',
    presets: [
      { id: 'offered-by-clinician', label: 'Slots offered by clinician',
        config: { grain: 'slots', num: { statuses: ['available','embargoed','booked'] }, denomMode: 'none', groupBy: 'clinician', range: 'last8next8', chart: 'bars' } },
      { id: 'fill-by-clinician', label: 'Fill rate by clinician',
        config: { grain: 'slots', num: { statuses: ['booked'] }, denomMode: 'group', groupBy: 'clinician', range: 'last8', chart: 'bars' } },
      { id: 'offered-by-location', label: 'Slots offered by site',
        config: { grain: 'slots', num: { statuses: ['available','embargoed','booked'] }, denomMode: 'none', groupBy: 'location', range: 'last8next8', chart: 'bars' } },
      { id: 'booked-by-dow', label: 'Booked by day of week',
        config: { grain: 'slots', num: { statuses: ['booked'] }, denomMode: 'none', groupBy: 'dow', range: 'last8', chart: 'bars' } },
      { id: 'urgent-share-by-clinician', label: 'Urgent share by clinician',
        config: { grain: 'slots', num: { categories: ['urgent'], statuses: ['available','embargoed','booked'] }, denomMode: 'group', groupBy: 'clinician', range: 'last8next8', chart: 'bars' } },
    ],
  },
  {
    group: 'Trends',
    presets: [
      { id: 'urgent-by-week', label: 'Urgent slots by week',
        config: { grain: 'slots', num: { categories: ['urgent'], statuses: ['available','embargoed','booked'] }, denomMode: 'none', groupBy: 'week', range: 'last8next8', chart: 'trend' } },
      { id: 'routine-by-week', label: 'Routine slots by week',
        config: { grain: 'slots', num: { categories: ['routine'], statuses: ['available','embargoed','booked'] }, denomMode: 'none', groupBy: 'week', range: 'last8next8', chart: 'trend' } },
      { id: 'fill-by-week', label: 'Fill rate by week',
        config: { grain: 'slots', num: { statuses: ['booked'] }, denomMode: 'group', groupBy: 'week', range: 'last8next8', chart: 'trend' } },
    ],
  },
];
