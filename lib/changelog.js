export const CHANGELOG = [
  {
    version: '4.68.4',
    date: '2026-06-11',
    title: 'Admin password reset links without email',
    changes: [
      { type: 'feature', text: 'Platform admins can now generate a password reset link directly from the admin user page and copy it to share by any channel. This bypasses email entirely, for cases where NHS mail filtering delays or quarantines reset emails' },
    ]
  },
  {
    version: '4.68.4',
    ...
    changes: [
      { type: 'feature', text: 'Platform admins can now generate a password reset link directly from the admin user page and copy it to share through any channel. This bypasses email entirely, for cases where NHS mail filtering delays or quarantines reset emails' },
    ]
  },
  {
    version: '4.69.0',
