export const CHANGELOG = [
  {
    version: '4.69.3',
    date: '2026-06-11',
    title: 'Diagnostics for reset links',
    changes: [
      { type: 'note', text: 'Temporary diagnostic added to the reset password screen to capture why links are being rejected. To be removed once the cause is fixed' },
    ]
  },
  {
    version: '4.69.2',
