...
import { normaliseLayout } from './report-schedules';
...
function renderText({ reports, practiceName, layout, intro, freshnessLine, url }) {
...
<body style="margin:0;padding:0;background:#f8fafc;font-family:${FONT};color:#334155;-webkit-font-smoothing:antialiased;">
  ...
  return {
    subject,
    html,
    text: renderText({ reports, practiceName, layout, intro, freshnessLine, url }),
    attachments,
