...
export const DEFAULT_CLINICIANS = [
  { id: 1, name: 'Dr. Ruth Harrison', initials: 'RH', role: 'GP Partner', sessions: 8, primaryBuddy: null, secondaryBuddy: null, longTermAbsent: false, canProvideCover: true },
  { id: 2, name: 'Dr. Trudi Mitchell', initials: 'TM', role: 'GP Partner', sessions: 8, primaryBuddy: null, secondaryBuddy: null, longTermAbsent: false, canProvideCover: true },
  { id: 3, name: 'Dr. Katie Chen', initials: 'KC', role: 'GP Partner', sessions: 6, primaryBuddy: null, secondaryBuddy: null, longTermAbsent: false, canProvideCover: true },
  { id: 4, name: 'Dr. Sarah Thompson', initials: 'ST', role: 'Salaried GP', sessions: 6, primaryBuddy: null, secondaryBuddy: null, longTermAbsent: false, canProvideCover: true },
  { id: 5, name: 'Alex Morgan', initials: 'AM', role: 'ANP', sessions: 8, primaryBuddy: null, secondaryBuddy: null, longTermAbsent: false, canProvideCover: true },
  { id: 6, name: 'Dr. James Wilson', initials: 'JW', role: 'Locum', sessions: 4, primaryBuddy: null, secondaryBuddy: null, longTermAbsent: false, canProvideCover: true },
  { id: 7, name: 'Emma Clarke', initials: 'EC', role: 'Paramedic Practitioner', sessions: 6, primaryBuddy: null, secondaryBuddy: null, longTermAbsent: false, canProvideCover: true },
  { id: 8, name: 'Dr. Michael Roberts', initials: 'MR', role: 'GP Registrar', sessions: 8, primaryBuddy: null, secondaryBuddy: null, longTermAbsent: false, canProvideCover: true },
];
