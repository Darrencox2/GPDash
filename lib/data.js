...
export const STAFF_GROUPS = {
  gp: { label: 'GP Team', roles: ['GP Partner', 'Salaried GP', 'GP Registrar', 'Locum', 'Medical Student'] },
...
export function guessGroupFromRole(role) {
  ...
  if (r.includes('gp') || r.includes('doctor') || r.includes('registrar') || r.includes('locum') || r.includes('medical student')) return 'gp';
