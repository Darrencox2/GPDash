...
const BASELINE = 131.38;

const DOW_EFFECTS = [49.87, 1.29, -11.14, -19.20, -21.49];
const DOW_NAMES = ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday'];

const MONTH_EFFECTS = [10.65, 10.25, 7.95, 1.87, -14.38, -1.42, -2.25, -10.85, -0.69, -4.11, 2.89, -11.61];
