...
export const RETENTION_POLICY = {
  ...
  // Client crash reports. Diagnostic signal, not a historical record —
  // ninety days is long enough to tell whether a fix held.
  app_errors: {
    table: 'app_errors',
    timestampColumn: 'created_at',
    keepDays: 90,
    description: 'Client-side crash reports',
    rationale: 'Operational diagnostics with no long-term value; stored with no names or emails.',
  },
};
