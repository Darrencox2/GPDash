  ...
  for (const site of sites) {
    ...
    for (const k of keys) {
      ...
      const clins = Object.values(b.byName).map((c) => ({
        ...
        // Anyone with bookable slots first, then duty, then alphabetical:
        // a session's readable answer is who is actually offering, and the
        // people who are not belong under that, not mixed through it.
