...
from (
  ...
  union all select 'meetings (confidential)',      (select count(*) from public.meetings        where practice_id = (select bid from other))
  union all select 'agenda_items (confidential)',  (select count(*) from public.agenda_items    where practice_id = (select bid from other))
  union all select 'meeting_actions (confidential)', (select count(*) from public.meeting_actions where practice_id = (select bid from other))
