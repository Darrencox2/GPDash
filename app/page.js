...
function AppContent() {
  ...
  return (
    <div className={`min-h-screen flex ${activeSection === 'huddle-today' || activeSection === 'buddy-cover' || activeSection === 'huddle-forward' || activeSection === 'my-rota' || activeSection === 'workload-audit' ? 'bg-[#0f172a]' : 'bg-slate-100'}`}>
      ...
      <main className={`flex-1 min-h-screen min-w-0 ${activeSection === 'huddle-today' || activeSection === 'buddy-cover' || activeSection === 'huddle-forward' || activeSection === 'my-rota' || activeSection === 'workload-audit' ? 'bg-[#0f172a]' : ''}`}>
