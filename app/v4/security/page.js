        ...
        {enrolling && (
          <div style={{ marginTop: 16, padding: 20, background: 'rgba(255,255,255,0.03)', borderRadius: 10, border: '1px solid rgba(255,255,255,0.06)' }}>
            ...
            <div style={{ display: 'flex', gap: 20, alignItems: 'flex-start', flexWrap: 'wrap' }}>
              <div
                style={{ background: 'white', padding: 12, borderRadius: 8, width: 200, height: 200 }}
                // qrSvg is an SVG string generated by Supabase's auth service
                // from the factor secret. It's not user content. dangerouslySetInnerHTML
                // is safe here — we're rendering known-safe SVG markup, not arbitrary HTML
                // from a third party.
